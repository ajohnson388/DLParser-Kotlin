...
data class License(
    ...
    var underEighteenUntilDate: Date? = null,
    var underNineteenUntilDate: Date? = null,
    var underTwentyOneUntilDate: Date? = null,
    ...
    var complianceType: Compliance? = null,
    var isOrganDonor: Boolean? = null,
    var isVeteran: Boolean? = null,
    var isTemporaryDocument: Boolean? = null,
    var isCommercial: Boolean? = null,
    var isNonDomiciled: Boolean? = null,
    var isEnhancedCredential: Boolean? = null,
    var isPermit: Boolean? = null,
    ...
    val isIssued: Boolean
        get() {
            return Date() > (issueDate ?: return false)
        }
